...
public class FileParserTest {
    ...
    public void extractTournamentTest() {
        ...
        TournamentDTO expectedTournamentDTO = TournamentDTO.builder().id(2834364251L).buyIn(BigDecimal.valueOf(0.23)).build();
    ...
    public void extractActionTest() {
        ...
        Action expected =
                Action.builder().playerDTO(PlayerDTO.builder().nickname("H3ll5cream").build()).typeAction(ALL_IN).value(2697L).build();
        assertEquals(expected, actual);
